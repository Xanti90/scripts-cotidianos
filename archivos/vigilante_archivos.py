...
LOG_PATH = Path(__file__).parent.parent.parent / "scripts-cotidianos/logs/vigilante.log"
...
class VigílanteArchivos(FileSystemEventHandler):
    ...
    def _programar(self, ruta_str: str):
